...
Q_SIGNALS:
     ...
     * \a numDeleted Number of to-dos that were deleted.
     * \a numIgnored Number of completed to-dos that weren't deleted because they are read-only
